...
const hr_core_controller_1 = require("./hr-core.controller");
...
exports.HrCoreModule = HrCoreModule = __decorate([
    (0, common_1.Module)({
        controllers: [hr_core_controller_1.HrCoreController],
        providers: [hr_core_service_1.HrCoreService],
        exports: [hr_core_service_1.HrCoreService],
    })
], HrCoreModule);
