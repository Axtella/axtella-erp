...
const platform_permission_entity_1 = require("./entities/platform-permission.entity");
...
exports.PermissionsModule = PermissionsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([platform_permission_entity_1.PlatformPermission])],
