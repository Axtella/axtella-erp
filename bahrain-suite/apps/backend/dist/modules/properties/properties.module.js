...
exports.PropertiesModule = PropertiesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([property_entity_1.Property, investor_entity_1.Investor])],
        controllers: [properties_controller_1.PropertiesController],
        providers: [properties_service_1.PropertiesService],
        exports: [typeorm_1.TypeOrmModule, properties_service_1.PropertiesService],
    })
], PropertiesModule);
