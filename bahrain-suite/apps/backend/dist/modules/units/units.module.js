...
exports.UnitsModule = UnitsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([unit_entity_1.Unit, property_entity_1.Property, cost_center_entity_1.CostCenter, unit_type_entity_1.UnitType])],
        controllers: [units_controller_1.UnitsController],
        providers: [units_service_1.UnitsService],
        exports: [typeorm_1.TypeOrmModule, units_service_1.UnitsService],
    })
], UnitsModule);
