...
let HotelGuestsService = class HotelGuestsService {
    ...
    async findAll(query, tenantId) {
        ...
        const qb = this.repo
            ...
            .take(limit);
        if (tenantId)
            qb.where('g.customer_id = :tenantId', { tenantId });
...
exports.HotelGuestsService = HotelGuestsService;
exports.HotelGuestsService = HotelGuestsService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(hotel_guest_entity_1.HotelGuest)),
