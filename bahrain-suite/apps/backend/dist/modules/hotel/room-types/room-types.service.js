...
let HotelRoomTypesService = class HotelRoomTypesService {
    ...
    async findAll(query, tenantId) {
        ...
        const qb = this.repo
            ...
            .take(limit);
        if (tenantId)
            qb.where('rt.customer_id = :tenantId', { tenantId });
        if (query.propertyId)
            qb.andWhere('rt.property_id = :propertyId', { propertyId: query.propertyId });
...
exports.HotelRoomTypesService = HotelRoomTypesService;
exports.HotelRoomTypesService = HotelRoomTypesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(hotel_room_type_entity_1.HotelRoomType)),
