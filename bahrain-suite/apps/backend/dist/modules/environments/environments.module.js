...
exports.EnvironmentsModule = EnvironmentsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([customer_environment_entity_1.CustomerEnvironment])],
        controllers: [environments_controller_1.EnvironmentsController],
        providers: [environments_service_1.EnvironmentsService],
        exports: [environments_service_1.EnvironmentsService, typeorm_1.TypeOrmModule],
    })
], EnvironmentsModule);
